...
import {addShift, loadShifts, prepShiftString, employeeSave, deleteShift} from '../actions';
...
class AddShiftScreen extends Component {
    ...
    saveShift = () => {
        ...
        employeeSave({name, lastName, phone, shift, uid, avatar: avatar || null, uniqueKey}, () =>
            navigation.goBack()
        );
    };
